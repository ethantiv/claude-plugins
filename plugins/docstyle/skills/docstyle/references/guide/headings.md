...
The following sections list and define our writing standards for capitalization, abbreviations, and technical elements in headings. In general, guidance that applies to standard text also applies to headings--for example, [contractions](/style/contractions) and [articles](/style/articles).

### Syntax and capitalization

  * **Use sentence case** for all headings and titles. For more information, see [Capitalization in titles and headings](/style/capitalization#capitalization-in-titles-and-headings).
...
### Formatting and code
  ...
  * **Avoid code items in headings**. If you must mention a code item in a heading, add a descriptive noun to the item in code font. For more information, see [Grammatical treatment of code elements](/style/code-in-text#grammatical-treatment-of-code-elements).

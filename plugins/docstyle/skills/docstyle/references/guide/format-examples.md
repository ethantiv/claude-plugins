...
To introduce an example in a sentence, use the guidance in the following table. You can introduce examples using _such as_ , _for example_ , or _like_ in various ways.

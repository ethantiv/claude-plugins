...
For details about how to use periods in lists, see the [Capitalization and end punctuation](/style/lists#capitalization-and-end-punctuation) section of the "Lists" page. 

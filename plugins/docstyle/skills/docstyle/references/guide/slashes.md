...
For information about how to write dates, see [Dates and times](/style/dates-times).
...
Often, _and_ implies _or_ , so you don't need to write both words. If you need to specify both in your content, avoid writing _and/or_ except when space is limited, such as in tables.

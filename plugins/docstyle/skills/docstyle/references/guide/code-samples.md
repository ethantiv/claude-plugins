...
Follow these guidelines when formatting code samples:
  ...
  * **Follow the indentation guidelines in the relevantcode style guide**. For most programming languages, this means using spaces instead of tabs and using two spaces for each indentation level. However, some contexts use four spaces for each indentation level, and some contexts use tabs. This guidance applies to formatting code samples, not to [formatting commands](/style/code-syntax#formatting-a-command).
...
For more information about how to introduce code samples, see [Document command-line syntax](/style/code-syntax). 

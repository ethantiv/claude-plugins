...
For more information about presenting output, also see the following: 
  ...
  * For more information about how to present output in procedures, see [Order of multiple components in a step](/style/procedures#order-of-multiple-components-in-a-step).

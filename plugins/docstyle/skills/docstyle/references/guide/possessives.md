...
Avoid using _'s_ to form a plural noun. For more information, see [Pluralization](/style/pluralization).

## Product, feature, and company names

When describing function or performance, don't form a possessive from a feature name, product name, or trademark, regardless of who owns it. Instead, use the name as a modifier or rewrite to use a word like _of_ to indicate the relationship.
...
To form the possessive of a company name, add _'s_ to the end of the name. Don't form the possessive of a company name when using it as a trademark.

Recommended: Google's new office is nearby.

Not recommended: The capabilities of Google's Search are vast.

For information about using trademarks as adjectives, not nouns, see [Trademarks](/style/trademarks#use-trademarks-as-adjectives). 
...
For more information, see [Grammatical treatment of code elements](/style/code-in-text#grammatical-treatment-of-code-elements).

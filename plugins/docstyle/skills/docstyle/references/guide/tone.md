...
## Some things to avoid where possible
  ...
  * Being too cutesy.
  * [Avoid figurative language](/style/inclusive-documentation#figurative-language), which includes metaphors and ableist language.
  ...
  * Exclamation marks. In general, avoid exclamation points. See [Specific guidance on exclamation points](/style/periods#exclamation-points).
  ...
  * Internet slang, or other [internet abbreviations](/style/abbreviations#dont-use) such as _[tl;dr](/style/word-list#tldr)_ or _[ymmv](/style/word-list#ymmv)_.

...
You can use Roman numerals for [sub-steps in numbered procedures](/style/procedures#sub-steps-in-numbered-procedures). 
...
When two or more hyphenated compounds that start with numbers modify the same word, use [suspended hyphens](/style/hyphens#suspended-hyphens).

Recommended: You can set up the system to scan for new files at one-, two-, or three-hour intervals.

## Currency

Make sure that it's clear what country's currency you are describing. For more information, see the [currency](/style/units-of-measure#currency) section in Units of measurement.
...
For general guidance on formatting mathematical notation, such as equations and variables, see [Mathematical notation](/style/mathematical-notation).

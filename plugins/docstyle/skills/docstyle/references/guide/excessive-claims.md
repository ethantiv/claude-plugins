...
In documentation, don't make excessive claims. An _excessive claim_ is an assertion in the documentation that does any of the following: 
...
Consider the following guidelines:
  ...
  * When you describe products, avoid superlatives like _best_ , _simplest_ , _fastest_ , _never_ , and _always_. Similarly, be careful about words like _ensure_ and _guarantee_ and use them only when something can truly be ensured or guaranteed. 

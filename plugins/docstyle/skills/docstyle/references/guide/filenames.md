...
When referring to a specific file, do the following:
  ...
  * Include the word _file_ after the filename. For more information, see [Grammatical treatment of code elements](/style/code-in-text#grammatical-treatment-of-code-elements).

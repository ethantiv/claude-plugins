...
const DATA = {
  ...
  ideas: [ {
    ...
    votes:[ ["Redaktor (finanse)",7.4], ["Marketing",7.5], ["Czytelnik docelowy",7.4], ["Analityk sprzedaży",6.8] ]
  } ],                                                // 5 pomysłów
  ...
  verdict: {
    ...
    score:"Średnia 7,3 &bull; najwyższa w stawce (7,4 / 7,5 / 7,4 / 6,8)",

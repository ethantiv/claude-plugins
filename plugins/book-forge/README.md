...
| --- | --- | --- | --- |
| 1 | `/book-forge:market-report` | ✅ | Interaktywny raport HTML: 10 bestsellerów niszy, 3 luki rynkowe, 5 pomysłów z roboczymi tytułami, ocena 1–10, wybór zwycięzcy. |
| 1L | `/book-forge:idea-spark` | ✅ | **Lekki wariant etapu 1** (bez badania rynku): 5 pomysłów z kwestionariusza, ocena rzemieślnicza (bez WebSearch), wybór zwycięzcy. `idea-spark-<gatunek>.html` + `.book-forge/pomysl.json`. |
| 2 | `/book-forge:outline` | ✅ | Konspekt rozdział po rozdziale (`.book-forge/konspekt.md` + interaktywny HTML) na bazie zwycięskiego pomysłu. |
| 3 | `/book-forge:book-bible` | ✅ | Biblia książki: jedno źródło prawdy (świat, postacie, głosy, glosariusz z odmianą, kanon, fakty). Zdekomponowany kanon-wiki `.book-forge/biblia/**/*.md` + `.book-forge/biblia/index.md`. |
